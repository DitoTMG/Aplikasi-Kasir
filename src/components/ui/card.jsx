...
const Card = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border border-slate-200/80 bg-white text-slate-900 shadow-sm dark:border-slate-800/80 dark:bg-slate-900/90 dark:text-slate-100 transition-colors",
      className
    )}
    {...props}
  />
